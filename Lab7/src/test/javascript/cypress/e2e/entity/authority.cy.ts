...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '9e591ba9-e503-4736-b7da-6d4b2f60e30b' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('bbad21c3-6901-4cdc-9606-8a334fed8cef');
      cy.get(`[data-cy="name"]`).should('have.value', 'bbad21c3-6901-4cdc-9606-8a334fed8cef');
